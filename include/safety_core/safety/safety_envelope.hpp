...
inline EnvelopeEvaluation evaluate_stop_distance(double distance_to_obstacle_m,
    ...
    const double braking_distance = (decel > 0.0) ? (speed * speed) / (2.0 * decel) : std::numeric_limits<double>::infinity();
