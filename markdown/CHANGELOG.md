...
- **Documentation Reorganization**: Moved all markdown files (README.md, CHANGELOG.md, CONTRIBUTING.md) to `markdown/` directory with symlinks at repository root for better organization.
