...
**A comprehensive overview of the Safety Autonomy Core project architecture, features, and development practices.**
...
AGV/AMR platforms operating in dynamic warehouses with:
...
| Technology | Purpose |
|------------|---------|
| **C++20** | Core language with MISRA/AUTOSAR-inspired coding rules |
| **CMake 3.20+** | Build system with presets for dev/safety/coverage |
| **CTest** | Testing framework with sanitizers (AddressSanitizer, UBSanitizer) |
| **clang-tidy/cppcheck** | Static analysis for code quality |
| **clang-format** | Code formatting with pre-commit hooks |
| **GitHub Actions** | CI/CD with intelligent job orchestration |
| **ROS 2 Jazzy** | Optional ament_cmake packaging for integration |
...
**Detailed Documentation**: See [CI_DOCUMENTATION.md](CI_DOCUMENTATION.md) for complete CI/CD pipeline details
...
- Multiple demo modes (Quick, Comprehensive, Interactive)
...
- **[CONTRIBUTING.md](CONTRIBUTING.md)** - Contribution guidelines and maintainer workflow
- **[AGENTS.md](AGENTS.md)** - AI agent development guidelines
- **[CI_DOCUMENTATION.md](CI_DOCUMENTATION.md)** - Comprehensive CI/CD pipeline documentation

### Safety Documentation

**markdown/docs/safety_case/** - ISO 26262/ISO 13849 evidence scaffolding:
- Functional safety plan
- V&V strategy and tool confidence register
...
- **[ros2/README.md](ros2/README.md)** - ROS 2 integration details and package documentation
- **[ros2/LOCALIZATION.md](ros2/LOCALIZATION.md)** - Advanced localization stack guide
- **[ros2/COMPREHENSIVE_DEMO.md](ros2/COMPREHENSIVE_DEMO.md)** - Complete demonstration guide

### Docker Documentation

- **[markdown/docs/DOCKER.md](markdown/docs/DOCKER.md)** - Complete Docker deployment guide
...
- **[CI Documentation](CI_DOCUMENTATION.md)**: Complete CI/CD pipeline guide
- **[ROS 2 Documentation](ros2/README.md)**: Integration and demo guides
- **[Safety Documentation](markdown/docs/safety_case/)**: ISO compliance and safety case artifacts
...
- Review [AGENTS.md](AGENTS.md) for AI agent development guidelines
...
**For quick start and installation instructions, see [README.md](README.md)**
